...
fun TipTimeLayout() {
    ...
    Column(
        modifier = Modifier
            ...
            .safeDrawingPadding()
            //activa el scroll y recuerda su state
...
fun EditNumberField(
    ...
    */
    ...
    TextField(
        ...
        value = value,
        //este parametro permite pasar un icono al TextField
        //usando una lambda que devolvera un icono que construye usando painterResource con el id del drawable
...
fun RoundTheTipRow(
    ...
    Row(modifier = modifier
        .fillMaxWidth()
        .size(48.dp),
        //recordar que vertical alignment es un parametro de Row
 ...
 */
//los componentes que se van a probar en los local tests
//deben de ser accesibles desde los componentes de pruebas
//la anotacion hace el motodo publico solo para fines de pruebas
@VisibleForTesting
